...
#       sql_on: ${last_screen.id} = ${last_custom.ref_client_program_demographics}          
    ...
    - join: programs
      fields: [ref_agency, name, project_type_code,  id, list_of_program_names, added_date, description, geocode, tracking_method,  program_applicability, status, ref_target_b,  count]
      sql_on: ${enrollments.ref_program} = ${programs.id}      
